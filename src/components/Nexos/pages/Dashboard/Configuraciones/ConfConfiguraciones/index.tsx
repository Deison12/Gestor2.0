...
const ConfConfiguraciones = () => {
    return (
        <>
            {/* Breadcrumb */}
            <BreadCrumb
                items={['Inicio', 'Configuraciones', 'Configuraciones']}
                baseURL={['', 'nexos/configuraciones', '']} />
            {/* Cards */}
            {/* <!-- row --> */}
            <TitleComponent title='Configuraciones - Configuraciones' />
...
export default ConfConfiguraciones;
